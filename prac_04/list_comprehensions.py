...
print(lowercase_full_names) # Output will include all the full names in lowercase
...
print(numbers) # Output will include all the integers from the almost_numbers list
...
print(numbers_greater_than_9) # Output will include only the numbers that are greater than 9
...
print(last_names_longer_than_11) # Output will be: 'Harlem, Hendrix, Lovelace'